...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/7d54491b539bc50e9d977.jpg), ɪᴍ ᴘʀɪɴꜱᴇᴄᴄ ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴘʀɪɴꜱᴇᴄᴄ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/PRINSECC_BOT?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="yone_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/PRIN_SECC"
        ),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [prinsecc 😍](https://telegra.ph/file/7d54491b539bc50e9d977.jpg) 
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *prinsecc*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_prinsecc licensed under the GNU General Public License v3.0_
                 \nHere is the [💾Repository](https://t.me/Ak_Dukhi_Aatma).
                 \n\nIf you have any question about prinsecc, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *prinsecc*
                 \nHere is the [Source Code](https://t.me/Ak_Dukhi_Aatma) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
